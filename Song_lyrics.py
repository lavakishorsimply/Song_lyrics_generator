        ...
        if song == '1':
            ...
            with open ('Faded.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Alan Walker Faded.mp3')
            ...
            with open ('Rasputin.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\BoneyM_Rasputin.mp3')
            ...
            with open ('Beliver.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Imagine Dragons Believer.mp3')
            ...
            with open ('Dance_Monkey.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\DANCE MONKEY.mp3')
            ...
            with open ('Falling.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Falling.mp3')
            ...
            with open ('Memories.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Maroon 5 Memories.mp3')
            ...
            with open ('Ma_Baker.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Ma Baker.mp3')
            ...
            with open ('Show_me_the_meaning.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Backstreet Boys Show Me The Meaning Of Being Lonely.mp3')
    ...
    while True:
        ...
        if song == '1':
            ...
            with open ('Chitti.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Chitti Song.mp3')
        elif song == '2':
            ...
            with open ('Kutty.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Kutti Story.mp3')
    ...
    while True:
        ...
        if song == '1':
            ...
            with open ('Agar_Tum_Saath_Ho.txt','r') as song_lyries:
                for line in song_lyries.readlines():
                    print(line)
                playsound('C:\\Users\\HOME\\Desktop\\songs\\Agar Tum Saath Ho.mp3')
        elif song == '0':
            Choice()           
        elif song == '9':
            sys.exit('Thank You!')
